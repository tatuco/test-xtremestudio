...
use App\Models\SectorDynamo as Sector;
use Carbon\Carbon;
use Illuminate\Http\Request;
use stdClass;
use Tymon\JWTAuth\Facades\JWTAuth;

class SectorDynamoService extends TatucoService
{
    ...
    public function index($request)
    {
        try {
            ...
            if ($user->account_id != $accountId) {
                ...
                $list = Sector::orderBy('created_at', 'asc')->get(['account_id',
                    'type_rack_id',
                    'type_rack_name',
                    'code',
                    'width',
    ...
    public function store(Request $request)
    {
        try {
            ...
            $sector->save();
            /**
aws dynamodb create-table --endpoint-url http://localhost:8001 --table-name Sector --attribute-definitions AttributeName=code,AttributeType=S AttributeName=high,AttributeType=S AttributeName=width,AttributeType=S AttributeName=type_rack_id,AttributeType=S AttributeName=type_rack_name,AttributeType=S AttributeName=account_id,AttributeType=S AttributeName=create_at,AttributeType=S AttributeName=norte,AttributeType=S AttributeName=sur,AttributeType=S AttributeName=racks,AttributeType=S --key-schema AttributeName=code,KeyType=HASH --provisioned-throughput ReadCapacityUnits=1,WriteCapacityUnits=1
             */
