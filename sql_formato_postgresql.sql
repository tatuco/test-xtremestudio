...
CREATE TABLE  "accesses" (
   ...
   "date_output"   timestamp without time zone DEFAULT NULL,
   "date_input"   timestamp without time zone DEFAULT NULL
)   ;
...
DROP TABLE "access_details" CASCADE\g
CREATE TABLE  "access_details" (
   "id" int CHECK ("id" >= 0) NOT NULL,
 "type" varchar CHECK ("type" IN ( 'input','output' )) COLLATE utf8_unicode_ci NOT NULL,
...
DROP TABLE "companies" CASCADE\g
...
DROP TABLE "contracts" CASCADE\g
CREATE TABLE  "contracts" (
   "cod_contract"   varchar(255) NOT NULL,
   "description"   varchar(255) DEFAULT NULL,
   ...
   "adm_aux_id"   char(25) NOT NULL,
   "admec_id"   char(25) NOT NULL,
   "admec_aux_id"   char(25) NOT NULL,
   "deleted"    smallint NOT NULL DEFAULT '0',
   "created_at"   timestamp NULL DEFAULT NULL,
   "updated_at"   timestamp NULL DEFAULT NULL
)   ;
...
DROP TABLE "detentions" CASCADE\g
...
DROP TABLE "detention_types" CASCADE\g
...
DROP TABLE "employes" CASCADE\g
CREATE TABLE  "employes" (
   "id"   int NOT NULL,
   "people_id"   char(25) NOT NULL,
   "company_id"   char(25) NOT NULL,
   "position_company"   char(255) NOT NULL,
...
CREATE TABLE  "events" (
   ...
   "description"   varchar(255) DEFAULT NULL,
   "date"   date NOT NULL,
   "out_of_time"    smallint NOT NULL DEFAULT '0',
   "type_id"   int NOT NULL,
   "status_id"   int NOT NULL,
   "check"    smallint NOT NULL DEFAULT '0',
   "deleted"    smallint NOT NULL DEFAULT '0',
   "detention_id"   char(255) NOT NULL,
   "created_at"   timestamp NULL DEFAULT NULL,
   "updated_at"   timestamp NULL DEFAULT NULL
)   ;
...
DROP TABLE "event_types" CASCADE\g
...
DROP TABLE "file_types" CASCADE\g
...
DROP TABLE "fingers_people" CASCADE\g
CREATE TABLE  "fingers_people" (
   "id" int CHECK ("id" >= 0) NOT NULL,
   "person_id"   char(25) NOT NULL,
   "deleted"    smallint NOT NULL DEFAULT '0',
   "created_at"   timestamp NULL DEFAULT NULL,
   "updated_at"   timestamp NULL DEFAULT NULL,
   "finger"   bytea
...
DROP TABLE "migrations" CASCADE\g
...
CREATE INDEX "params_25_idx" ON "params" USING btree ("25");
...
DROP TABLE "password_resets" CASCADE\g
...
DROP TABLE "people" CASCADE\g
CREATE TABLE  "people" (
   "id"   char(25) NOT NULL,
   "image"   varchar(255) DEFAULT NULL,
   "name"   varchar(50) NOT NULL,
   "last_name_p"   varchar(25) NOT NULL,
   "last_name_m"   varchar(25) NOT NULL,
   "date_birth"   date DEFAULT NULL,
 "civil_status" varchar CHECK ("civil_status" IN ( 'single','married','divorced' )) COLLATE utf8_unicode_ci DEFAULT NULL,
 "sex" varchar CHECK ("sex" IN ( 'male','female' )) COLLATE utf8_unicode_ci DEFAULT NULL,
...
DROP TABLE "permissions" CASCADE\g
...
DROP TABLE "permission_role" CASCADE\g
...
DROP TABLE "permission_user" CASCADE\g
...
DROP TABLE "person_types" CASCADE\g
...
DROP TABLE "person_user" CASCADE\g
...
DROP TABLE "position_companies" CASCADE\g
...
DROP TABLE "position_company_pivot_contracts" CASCADE\g
...
DROP TABLE "requirements_company" CASCADE\g
CREATE TABLE  "requirements_company" (
   "id"   int NOT NULL,
   "description"   varchar(255) DEFAULT NULL,
   "company_id"   char(25) NOT NULL,
   "contract_id"   char(25) NOT NULL,
 "check" varchar CHECK ("check" IN ( 'active','disabled' )) COLLATE utf8_unicode_ci NOT NULL,
   "deleted"    smallint NOT NULL DEFAULT '0',
   "created_at"   timestamp NULL DEFAULT NULL,
   "updated_at"   timestamp NULL DEFAULT NULL
)   ;
...
DROP TABLE "requirements_people" CASCADE\g
...
DROP TABLE "role_user" CASCADE\g
...
DROP TABLE "status_events" CASCADE\g
...
DROP TABLE "sub_events" CASCADE\g
...
DROP TABLE "turns" CASCADE\g
CREATE TABLE  "turns" (
   "id"   int NOT NULL,
   "description"   varchar(255) DEFAULT NULL,
   "working_days"   int DEFAULT NULL,
   "break_days"   int DEFAULT NULL,
 "shift" varchar CHECK ("shift" IN ( 'diurnal','night' )) COLLATE utf8_unicode_ci NOT NULL,
   "company_id"   char(25) NOT NULL,
   "contract_id"   char(25) NOT NULL,
   "deleted"    smallint NOT NULL DEFAULT '0',
   "created_at"   timestamp NULL DEFAULT NULL,
